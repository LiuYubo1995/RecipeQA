...
model.train(train_corpus, total_examples=model.corpus_count, epochs=args.epochs)
print(model.infer_vector(['i', 'am', 'a', 'student']))
fname = get_tmpfile("/Users/LYB/Desktop/coursework/Msc-project/recipe_baseline/impatient_reader_simple_baseline/train_doc2vec/my_doc2vec_model")
model.save(fname) 
